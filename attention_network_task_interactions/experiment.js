...
var end_block = {
	...
	data: {
		trial_id: "end",
    	exp_id: 'attention_network_task_interactions'
	},
	timing_response: 180000,
	timing_post_trial: 0,
...
for (i = 0; i < block.data.length; i++) {
	...
	if (block.data[i].cue == 'nocue') {
		...
		attention_network_task_interactions_experiment.push(spatial_cue)
	}

	attention_network_task_interactions_experiment.push(fixation)
	...
	attention_network_task_interactions_experiment.push(attention_network_task_practice_trial)
...
for (b = 0; b < blocks.length; b++) {
	...
	for (i = 0; i < block.data.length; i++) {
		...
		attention_network_task_interactions_experiment.push(ANT_trial)
	...
	attention_network_task_interactions_experiment.push(attention_node)
	attention_network_task_interactions_experiment.push(rest_block)
}
attention_network_task_interactions_experiment.push(post_task_block)
attention_network_task_interactions_experiment.push(end_block)